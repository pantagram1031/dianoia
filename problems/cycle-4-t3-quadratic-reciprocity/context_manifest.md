...
always:
  ...
  - goal.md
  - AGENTS.md
  - problems/cycle-4-t3-quadratic-reciprocity/session_state.md
  - problems/cycle-4-t3-quadratic-reciprocity/claim_ledger.md

phase_active:
  artifact: problems/cycle-4-t3-quadratic-reciprocity/result.md
