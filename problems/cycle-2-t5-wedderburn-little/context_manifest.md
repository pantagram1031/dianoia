...
unit_id: cycle-2-t5-stuck-state
phase: 4-develop
...
always:
  ...
  - goal.md
  - AGENTS.md
  - problems/cycle-2-t5-wedderburn-little/session_state.md
  - problems/cycle-2-t5-wedderburn-little/claim_ledger.md

phase_active:
  artifact: problems/cycle-2-t5-wedderburn-little/failures/normalizer-counting-gap.md
...
checkpoint_evidence:
  ...
  next_atomic_unit: cycle-2 T6

dropped:
  - path: completed T1-T4 cycle directories
    reason: not needed for T5 obstruction preservation
    recovery: reload from problems/cycle-2-t*/ and capability-test/cycle-2/T*-audit.md

notes:
  - Halt is intentional: the system records the obstruction instead of claiming a proof.