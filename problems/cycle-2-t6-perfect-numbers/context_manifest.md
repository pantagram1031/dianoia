...
always:
  ...
  - goal.md
  - AGENTS.md
  - problems/cycle-2-t6-perfect-numbers/session_state.md
  - problems/cycle-2-t6-perfect-numbers/claim_ledger.md

phase_active:
  artifact: problems/cycle-2-t6-perfect-numbers/failures/ambition-gap.md
