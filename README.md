...
- Local baseline verifier: `python tools\verify_dianoia_state.py`.
  This also checks B6+ source citation metadata, structured comparison
  verdict consistency, difference evidence, source artifact paths,
  run workspace paths, `UNVERIFIED` token blockers/plans, and that referenced
