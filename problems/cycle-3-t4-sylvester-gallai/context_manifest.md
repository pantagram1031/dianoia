...
always:
  ...
  - goal.md
  - AGENTS.md
  - problems/cycle-3-t4-sylvester-gallai/session_state.md
  - problems/cycle-3-t4-sylvester-gallai/claim_ledger.md

phase_active:
  artifact: problems/cycle-3-t4-sylvester-gallai/result.md
