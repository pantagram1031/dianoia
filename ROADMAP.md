...
| 2 | FIX | IN_PROGRESS | prompts/prove.md and active-guard patches smoke-tested; R1 router risk remains |
...
Continue Phase 2 at the constitutional routing decision. Prompt-level guards
passed smoke testing, but DIAGNOSIS R1 remains UNVERIFIED because `AGENTS.md`
route selection is constitutional and unchanged.
