...
always:
  ...
  - goal.md
  - AGENTS.md
  - problems/cycle-3-t2-intermediate-value/session_state.md
  - problems/cycle-3-t2-intermediate-value/claim_ledger.md
phase_active:
  artifact: problems/cycle-3-t2-intermediate-value/result.md
