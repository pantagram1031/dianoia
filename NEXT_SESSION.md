...
- Baseline verifier exists: `python tools\verify_dianoia_state.py`. Latest
  smoke is `capability-test/BENCHMARK-TOKEN-UNVERIFIED-VERIFY-20260521.md`;
  ...
  evidence, `UNVERIFIED` token blockers/plans, and that docs/state references
  to `capability-test/*.md` artifacts resolve.
